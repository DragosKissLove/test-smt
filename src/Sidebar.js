...
const tabs = [
  ...
  { id: 'About', icon: FiInfo, tooltip: 'Info' }
];
...
const Sidebar = ({ active, onChange, user }) => {
  ...
  // Discord SVG Logo Component
  const DiscordLogo = ({ size = 24, color = "#5865F2" }) => (
  ...
  return (
    ...
    >
      ...
      <div style={{ 
        ...
        {/* Discord Button with Discord Logo */}
        <motion.div
          variants={itemVariants}
          style={{ position: 'relative' }}
          whileHover="hover"
        >
          ...
          >
            <DiscordLogo size={24} color="#5865F2" />
          </motion.button>
